...
function ViewContract() {
  ...
  const handleFeedbackSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("accessToken")
      await axios.post(
        `${process.env.REACT_APP_API_BASE_URL}/orders/orders-list/${orderId}/user-feedback/`,
        {
  ...
  const handleSubmitContract = async () => {
    ...
    try {
      ...
      const token = localStorage.getItem("accessToken")
      await axios.post(
        `${process.env.REACT_APP_API_BASE_URL}/orders/orders-list/${orderId}/contracts/user/upload/`,
        formData,
        {
          headers: {
        ...
        <div className="contract-column">
          <div className="card order-summary">
            ...
            <p>
              ...
              <span className="clickable-username" onClick={() => handleUsernameClick(order.constructor)}>
                {order.constructor_username} (Click to view detail)
              </span>
            </p>
          </div>
